...
const btnCreateText = document.getElementById('btn-createText')
btnCreateText.addEventListener('click', () => {
  const text = document.createElement('h2')
  text.innerText = 'Hello, world'
  text.id = 'new-line'
  document.body.appendChild(text)
  const btnChangeTextStyle = document.querySelector('#btn-changeTextStyle')
  btnChangeTextStyle.addEventListener('click', () => {
    text.className = 'new-line'
  })
  const btnRemoveText = document.getElementById('btn-removeText')
